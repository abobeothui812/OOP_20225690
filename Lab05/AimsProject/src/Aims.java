...
public class Aims {
    ...
    public static void main(String[] args) {
        ...
        DvDstore.addItemtoStore(new DigitalVideoDisc("Star Wars", "Science Fiction", "George Lucas", 24.95f, 0));
                          ...
                          if( item instanceof DigitalVideoDisc || item instanceof CompactDisc){
                              if (item instanceof DigitalVideoDisc) {
                                  try {
                                    ...
                                    System.out.println("Error playing DVD: " + e.getMessage());
                                    e.printStackTrace();
                                    JOptionPane.showMessageDialog(
                                    null, 
                                    "Error: " + e.getMessage(), 
